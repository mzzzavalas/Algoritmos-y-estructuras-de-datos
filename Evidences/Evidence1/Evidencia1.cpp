...
int main() {
    ...
    ofstream output_file("output608.txt");
...
cout<<"---------------------------------------------------------------------"<<endl;
    // Imprimir los registros ordenados con funcion print
    //print(listAux);
    // Imprimir los registros ordenados con for
    ...
    do {
        ...
        cout << "AN0: "; cin >> year1;
        cout << "MES (en numero ej;09): "; cin >> month1;
        cout << "DIA: "; cin >> day1;
        cout << "Tiempo(Ej; 03:12:21): "; cin >> time1;
        ...
        cout << "AN0: "; cin >> year2;
        cout << "MES (en numero ej;09): "; cin >> month2;
        cout << "DIA: "; cin >> day2;
        cout << "Tiempo(Ej; 03:12:21): "; cin >> time2;
    ...
    ofstream range_file("range608.txt");
if (range_file.is_open()) {
    for (int i = mid; i <= mid2; i++) {
        range_file << listAux[i] << endl;
    }
    range_file.close();
    cout << "Resultados del rango de busqueda almacenados en 'range608.txt'" << endl;
} else {
    cerr << "No se pudo abrir el archivo 'range608.txt' para escritura" << endl;
}
