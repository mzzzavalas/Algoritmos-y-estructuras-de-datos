...
int opcion;
    do {
        ...
        cout << "3. Búsqueda por rango de ip's con el algoritmo de búsqueda secuencial" << endl;
        ...
        switch (opcion) {
            case 1: {
                ...
                //logs.print("asc");
                cout << "Resultados del ordenamiento almacenados en 'output602-1.out'" << endl;
                break;
            }
            case 2: {
                ...
                ip_fecha_hora.close();
                //logsIP.print("asc");
                cout << "Resultados del ordenamiento almacenados en 'output602-2.out'" << endl;
                break;
            }
            case 3: {
                //RANGO
